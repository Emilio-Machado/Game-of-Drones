...
namespace Game_of_Drones.Migrations
{
    ...
    [Migration("20241105192150_SetKillMoveIds")]
    partial class SetKillMoveIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Game_of_Drones.Models.Move", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 11, 5, 16, 21, 49, 761, DateTimeKind.Local).AddTicks(2016),
                            IsActive = true,
                            Name = "Piedra"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 11, 5, 16, 21, 49, 761, DateTimeKind.Local).AddTicks(2018),
                            IsActive = true,
                            Name = "Papel"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 11, 5, 16, 21, 49, 761, DateTimeKind.Local).AddTicks(2020),
                            IsActive = true,
                            Name = "Tijera"
                        });
                });
